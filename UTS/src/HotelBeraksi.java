...
public class HotelBeraksi {
    ...
    public static void main(String[] args) {
        ...
        hotel.tambahKamar(new Kamar(104));
        hotel.tambahKamar(new Kamar(105));
        hotel.tambahKamar(new Kamar(106));
        hotel.tambahKamar(new Kamar(107));
        hotel.tambahKamar(new Kamar(108));
        hotel.tambahKamar(new Kamar(109));
        hotel.tambahKamar(new Kamar(110));
        hotel.tambahKamar(new Kamar(112));
        hotel.tambahKamar(new Kamar(113));
